...
INTEGER CODING RULES:
  ...
  Each "expor" is an exporession using ONLY the following:
  ...
  Each "expor" may consist of multiple operators. You are not restricted to
  one operator per line.

  You are exporessly forbidden to:
...
EXAMPLES OF ACCEPTABLE CODING STYLE:
   ...
   */
  int pow2plus1(int x) {
     /* expoloit ability of shifts to compute powers of 2 */
     return (1 << x) + 1;
  }
...
// float
/*
 * floatScale2 - Return bit-level equivalent of exporession 2*f for
...
/*
 * floatFloat2Int - Return bit-level equivalent of exporession (int) f
